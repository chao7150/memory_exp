...
describe("Indexes of", () => {
  expect(actions.IndexesOf([0, 1, 2], 2)).toEqual([2])
  expect(actions.IndexesOf([2, 1, 0, 1, 2], 2)).toEqual([0, 4])
  expect(actions.IndexesOf([2], 2)).toEqual([0])
  expect(actions.IndexesOf([], 2)).toEqual([])
})

describe("separate into series", () => {
  expect(actions.separateIntoSeries([
    { seriesNum: 1 },
    { seriesNum: 2 },
    { seriesNum: 2 },
    { seriesNum: 3 },
...
describe("calculate representative value of the series", () => {
  test("no correct trial in the series", () => {
    expect(actions.calcReprOfSeries([
